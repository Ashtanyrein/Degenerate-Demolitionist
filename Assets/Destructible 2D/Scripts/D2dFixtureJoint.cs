...
namespace Destructible2D.Inspector
{
	...
	[CustomEditor(typeof(D2dFixtureJoint))]
	public class D2dFixtureJoint_Editor : D2dEditor<D2dFixtureJoint>
	{
		protected override void OnInspector()
		{
			BeginError(Any(t => t.Joint == null));
			...
			{
				BeginError(Any(t => t.Fixture == null));
					Draw("fixture", "This is the fixture associated with the joint.");
				EndError();
			}
			BeginError(Any(t => t.ConnectedFixture == null));
