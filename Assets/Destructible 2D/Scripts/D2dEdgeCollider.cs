...
namespace Destructible2D
{
	...
	public class D2dEdgeCollider : D2dCollider
	{
		...
		public float Optimize { set { optimize = value; Rebuild(); } get { return optimize; } } [FSA("straighten")] [SerializeField] [Range(0.0f, 0.5f)] private float optimize = 0.01f;
...
namespace Destructible2D.Inspector
{
	...
	public class D2dEdgeCollider_Editor : D2dCollider_Editor<D2dEdgeCollider>
	{
		protected override void OnInspector()
		{
			...
			DrawDefault("optimize", ref rebuild, "This allows you to control how easily the edges can merge together. A higher value gives better performance, but less accurate colliders.");
